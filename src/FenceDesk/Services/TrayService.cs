...
public sealed class TrayService : IDisposable
{
    ...
    public void Initialize()
    {
        ...
        menu.Items.Add("Reset all fence colors", null, (_, _) => Safe(_manager.ResetAllBackgroundColors));
        menu.Items.Add(new ToolStripSeparator());
        ...
        menu.Items.Add("About FenceDesk", null, (_, _) =>
        {
            MessageBox.Show(
                ...
                "C# + WinUI 3 port. Inspired by Stardock Fences (independent clone).\n\n" +
                "Right-click a fence for options (color, opacity, tabs).\n" +
                "Drop files onto fences to organize.\n" +
                "Use the tray menu or control panel to Show, Hide, create fences, or Exit.",
                "FenceDesk",
    ...
    private static Icon LoadIcon()
    {
        ...
        {
            g.Clear(Color.FromArgb(255, 30, 48, 80));
            using var brush = new SolidBrush(Color.FromArgb(255, 160, 190, 230));
