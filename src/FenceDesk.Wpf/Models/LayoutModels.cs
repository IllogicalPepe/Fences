...
public sealed class FenceLayout
{
    ...
    /// <summary>Optional display names for fence groups (key = groupId).</summary>
    [JsonPropertyName("groups")]
    public Dictionary<string, string> Groups { get; set; } = new(StringComparer.Ordinal);
}
...
public sealed class FenceModel
{
    ...
    /// <summary>Title + item label color (hex #RRGGBB).</summary>
    [JsonPropertyName("textColor")]
    public string TextColor { get; set; } = "#C8D0DC";
